...
from inverse_text_normalization.mr.run_predict import inverse_normalize_text
from en_number_extractor import ENNumberExtractor

class MRNumberExtractor():
    """
...
if __name__ == "__main__":
    ...
    extractor_obj = MRNumberExtractor(lang,"/home/jatin/number_extractor/configs/num_ext.json",normalizer=normalizer,use_translate=False,translation_model=None,debug=True)
    examples = {
        "hi":[
        "सौ एकर जमीन है",
        "पाँच सौ एकर जमीन है",
